...
esp_err_t ir_nec_parse_frame(rmt_symbol_word_t *rmt_nec_symbols, uint16_t *ret_nec_code_address, uint16_t *ret_nec_code_command)
{
    ...
    *ret_nec_code_address = address;
    *ret_nec_code_command = command;
    return ESP_OK;
}
